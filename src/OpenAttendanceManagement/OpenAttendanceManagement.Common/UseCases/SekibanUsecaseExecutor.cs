...
public class SekibanUsecaseExecutor(ISekibanUsecaseContext context) : ISekibanUsecaseExecutor
{
    ...
    public ResultBox<TOut> Execute<TIn, TOut>(ISekibanUsecase<TIn, TOut> usecaseAsync) where TIn : class, ISekibanUsecase<TIn, TOut>, IEquatable<TIn> where TOut : notnull =>
